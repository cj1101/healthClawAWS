...
rem Override any variable before calling, e.g. set EC2_HOST=1.2.3.4 && ec2-sync-and-restart.cmd

if not defined EC2_KEY set "EC2_KEY=C:\Users\charl\openclawKey.pem"
if not defined EC2_HOST set "EC2_HOST=44.200.84.118"
if not defined EC2_USER set "EC2_USER=ubuntu"
